...
void test1()
{
        unsigned int M=0;
        unsigned int N=0;
        FileReader ra("./txt_files/a.txt"), rb("./txt_files/gauss_seidel.txt");
        FileWriter wc("./txt_files/gauss_seidel_test_result.txt");
        M = ra.getnumrow();
        N = rb.getnumcolumn();
...
void test2()
{
        ...
        std::cout << "eps = ";
        std::cin >> eps ;
        FileReader ra("./txt_files/gauss_seidel_test_result.txt"), rb("./txt_files/b.txt");
        //FileWriter wc("./txt_files/gauss_seidel_test_result.txt");
        M = ra.getnumrow();
        N = rb.getnumcolumn();
        Matrix a(M,M), b(M,N);
